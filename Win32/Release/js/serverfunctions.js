...
function TServerMethods1(connectionInfo)
{
  ...
  /*
   * @param Table [in] - Type on server: string
   * @param Field [in] - Type on server: string
   * @param Value [in] - Type on server: string
   * @return result - Type on server: TJSONArray
   */
  this.OpenQuery1 = function(Table, Field, Value) {
    var returnObject = this.executor.executeMethod('OpenQuery1', "GET", [Table, Field, Value], arguments[3], true, arguments[4], arguments[5]);
    if (arguments[3] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.Table = Table;
        resultObject.Field = Field;
        resultObject.Value = Value;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
  ...
  this.OpenQuery1_URL = function(Table, Field, Value) {
    return this.executor.getMethodURL("OpenQuery1", "GET", [Table, Field, Value], arguments[3])[0];
  };

  /*
   * @param Table [in] - Type on server: string
   * @param Field1 [in] - Type on server: string
   * @param Field2 [in] - Type on server: string
   * @param Value1 [in] - Type on server: string
   * @param Value2 [in] - Type on server: string
   * @return result - Type on server: Boolean
   */
  this.SaveData1 = function(Table, Field1, Field2, Value1, Value2) {
    var returnObject = this.executor.executeMethod('SaveData1', "GET", [Table, Field1, Field2, Value1, Value2], arguments[5], true, arguments[6], arguments[7]);
    if (arguments[5] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.Table = Table;
        resultObject.Field1 = Field1;
        resultObject.Field2 = Field2;
        resultObject.Value1 = Value1;
        resultObject.Value2 = Value2;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.SaveData1_URL = function(Table, Field1, Field2, Value1, Value2) {
    return this.executor.getMethodURL("SaveData1", "GET", [Table, Field1, Field2, Value1, Value2], arguments[5])[0];
  };

  /*
   * @param Test [in] - Type on server: string
   * @return result - Type on server: string
   */
  this.UploadImage = function(Test) {
    var returnObject = this.executor.executeMethod('UploadImage', "GET", [Test], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.UploadImage_URL = function(Test) {
    return this.executor.getMethodURL("UploadImage", "GET", [Test], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["EchoString","ReverseString","OpenQuery1","SaveData1","UploadImage"]
};
