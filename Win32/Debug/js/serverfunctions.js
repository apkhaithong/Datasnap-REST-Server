...
function TServerMethods1(connectionInfo)
{
   ...
   * @return result - Type on server: TJSONArray
   */
  this.OpenQuery1 = function(Value1, Value2) {
    var returnObject = this.executor.executeMethod('OpenQuery1', "GET", [Value1, Value2], arguments[2], true, arguments[3], arguments[4]);
    if (arguments[2] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.OpenQuery1_URL = function(Value1, Value2) {
    return this.executor.getMethodURL("OpenQuery1", "GET", [Value1, Value2], arguments[2])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["EchoString","ReverseString","OpenQuery1"]
};
